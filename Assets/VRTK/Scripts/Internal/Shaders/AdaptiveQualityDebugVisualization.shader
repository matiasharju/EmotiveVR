        ...
        Pass
        {
            ...
            CGPROGRAM
                ...
                CBUFFER_START(AdaptiveQualityDebugVisualization)
                    int _RenderScaleLevelsCount = 10;
                    int _DefaultRenderViewportScaleLevel = 6;
                    int _CurrentRenderViewportScaleLevel = 5;
                    int _CurrentRenderScaleLevel = 5;
                    int _LastFrameIsInBudget = 1;
                CBUFFER_END
                ...
                fixed4 frag(v2f_img i) : SV_TARGET0
                {
                    ...
                    int nLevel = i.uv.x * _RenderScaleLevelsCount;
